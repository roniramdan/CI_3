            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="<?php echo base_url('jenis_buku'); ?>">Jenis Juku</a>
                        </li>
                        <li class="nav-item">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td> <a href="<?php echo base_url('jenis_buku/ubah/' . $v->id); ?>"> Edit </a> | <a href="<?php echo base_url('jenis_buku/hapus/' . $v->id); ?>"> Hapus </a></td>
                    </tr>
                <?php
                }
                ?>

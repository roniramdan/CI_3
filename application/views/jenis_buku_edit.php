...
<body class="d-flex flex-column h-100">
    ...
    <div class="container">
        <form action="<?php echo base_url('jenis_buku/saveubah'); ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" value="<?php echo $fetch->id; ?>" name="id">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Jenis Buku</label>
                <input type="text" class="form-control" id="jenis_buku" name="jenis_buku" value="<?php echo $fetch->jenis_buku; ?>">
            </div>
